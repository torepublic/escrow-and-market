...
if ($cur_forum['id']== $forum_config['o_problem_forum_id'] || $cur_forum['id']== $forum_config['o_problem_archive_id'])
{
	$isproblemforum =1;
...
$forum_user['may_post'] = (($cur_forum['post_topics'] == '' && $forum_user['g_post_topics'] == '1') 
|| $cur_forum['post_topics'] == '1' || $forum_page['is_admmod'] ) ? true : false;

//|| $isproblemforum && ( $forum_user['id']==$buyerid || $forum_user['id']==$sellerid)
