...
<?php ($hook = get_hook('aop_setup_pre_topic_review2')) ? eval($hook) : null; ?>
					<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
						<div class="sf-box frm-short text">
							...
							<span class="fld-input"><input type="number" id="fld<?php echo $forum_page['fld_count'] ?>" name="form[minimum_escrow_value]" size="5" maxlength="3" value="<?php echo $forum_config['o_minimum_escrow_value'] ?>" /></span>
						</div>
					</div>
